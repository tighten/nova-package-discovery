...
Nova.booting(function (Vue, router) {
    Vue.component('nova-package-discovery', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        Nova.request().get('/nova-vendor/nova-package-discovery/recent-packages').then(function (response) {
            _this.recentPackages = response.data;
        });
...
var render = function() {
  ...
  return _c("card", [
    _c("div", { staticClass: "px-3 py-3" }, [
      ...
      _vm._v(" "),
      _c("h2", { staticClass: "text-base mt-4" }, [_vm._v("Recent packages")]),
      _vm._v(" "),
      _c(
        "ul",
      ...
      _vm._v(" "),
      _c("h2", { staticClass: "text-base mt-4" }, [_vm._v("Popular packages")]),
      _vm._v(" "),
      _c(
        "ul",
        { staticClass: "leading-normal" },
